...
### D3 — The Auto-Merge Enabler Cookbook — Storefront pick

- **WHAT:** ⚑ Storefront pick: Gumroad (default — the click-script's HOW is written against it; same account as the live SWTK listing) or Lemon Squeezy — owner's call; either works with the same zip + copy.
- **WHERE:** `docs/publishing/vetting/auto-merge-enabler-cookbook.md` @ §7, OWNER-ACTION step 2
- **DEFAULT:** **Gumroad**
- **UNBLOCKS:** the “The Auto-Merge Enabler Cookbook” publish sequence continuing past this pick

### D4 — CORS Preflight Test Kit — Storefront pick

- **WHAT:** ⚑ Storefront pick: Gumroad (default — same account as the live Stripe kit listing; the click-script's HOW is written against it) or Lemon Squeezy — owner's call; either works with the same zip + copy.
- **WHERE:** `docs/publishing/vetting/cors-preflight-test-kit.md` @ §7, OWNER-ACTION step 2
- **DEFAULT:** **Gumroad**
- **UNBLOCKS:** the “CORS Preflight Test Kit” publish sequence continuing past this pick

### D5 — The False-Green Test Trap — Storefront pick
...
- **WHAT:** ⚑ Storefront pick: Gumroad (default — same account as the live Stripe kit listing; the click-script's HOW is written against it) or Lemon Squeezy — owner's call; either works with the same zip + copy.
- **WHERE:** `docs/publishing/vetting/idempotency-key-test-kit.md` @ §7, OWNER-ACTION step 2
- **DEFAULT:** **Gumroad**
- **UNBLOCKS:** the “Idempotency Key Test Kit” publish sequence continuing past this pick

### D8 — The Idempotency & Retry Cookbook — Storefront pick

- **WHAT:** ⚑ Storefront pick: Gumroad (default — the click-script's HOW is written against it; same account as the live SWTK listing) or Lemon Squeezy — owner's call; either works with the same zip + copy.
- **WHERE:** `docs/publishing/vetting/idempotency-retry-cookbook.md` @ §7, OWNER-ACTION step 2
- **DEFAULT:** **Gumroad**
- **UNBLOCKS:** the “The Idempotency & Retry Cookbook” publish sequence continuing past this pick

### D9 — JWT Auth Test Kit — Storefront pick

- **WHAT:** ⚑ Storefront pick: Gumroad (default — same account as the live Stripe kit listing; the click-script's HOW is written against it) or Lemon Squeezy — owner's call; either works with the same zip + copy.
- **WHERE:** `docs/publishing/vetting/jwt-auth-test-kit.md` @ §7, OWNER-ACTION step 2
- **DEFAULT:** **Gumroad**
- **UNBLOCKS:** the “JWT Auth Test Kit” publish sequence continuing past this pick

### D10 — Kill-Rule Intake Kit — Storefront pick
...
### D11 — Membership-Site Boilerplate Kit — Storefront pick
...
### D12 — The Agent Merge-Wall Cookbook — Storefront pick
...
### D13 — Multi-Agent Control-Plane Pack — Storefront pick
...
### D14 — Owner-Click Queue Kit — Storefront pick
...
### D15 — Pagination Test Kit — Storefront pick

- **WHAT:** ⚑ Storefront pick: Gumroad (default — same account as the live Stripe kit listing; the click-script's HOW is written against it) or Lemon Squeezy — owner's call; either works with the same zip + copy.
- **WHERE:** `docs/publishing/vetting/pagination-test-kit.md` @ §7, OWNER-ACTION step 2
- **DEFAULT:** **Gumroad**
- **UNBLOCKS:** the “Pagination Test Kit” publish sequence continuing past this pick

### D16 — Photo Packs (Dutch Skies + Golden Hours) — Storefront pick
...
### D17 — Photo Packs (Dutch Skies + Golden Hours) — Price
...
### D18 — Rate-Limit Test Kit — Storefront pick

- **WHAT:** ⚑ Storefront pick: Gumroad (default — same account as the live Stripe kit listing; the click-script's HOW is written against it) or Lemon Squeezy — owner's call; either works with the same zip + copy.
- **WHERE:** `docs/publishing/vetting/rate-limit-test-kit.md` @ §7, OWNER-ACTION step 2
- **DEFAULT:** **Gumroad**
- **UNBLOCKS:** the “Rate-Limit Test Kit” publish sequence continuing past this pick

### D19 — Shopify Webhook Test Kit — Storefront pick
...
### D20 — Slack Webhook Test Kit — Storefront pick
...
### D21 — Agent-Workflow Template Pack — Storefront pick
...
### D22 — The Painted Stones — Illustration decision
...
### D23 — The Puddle Museum — Illustration decision
...
### D24 — The Weigh House — Title + subtitle
...
### D25 — The Windmill Mouse — Illustration decision
...
### D27 — Weduwenblauw — Title coupling
...
### D28 — Keyword map C1 — Category Literary Fiction
...
### CORS Preflight Test Kit — `docs/publishing/vetting/cors-preflight-test-kit.md` @ §7 checklist

- [ ] **WHAT:** storefront pick (Gumroad (default)) — or Lemon Squeezy. · **DEFAULT:** **Gumroad** (executes its D-item above) · **UNBLOCKS:** the next click in this sequence
- [ ] **WHAT:** zip uploaded + sha256 spot-check against §1. · **UNBLOCKS:** the next click in this sequence
- [ ] **WHAT:** listing copy pasted + refund/license lines set. · **UNBLOCKS:** the next click in this sequence
- [ ] **WHAT:** price set ($29 one-time (default per catalog precedent + the live Stripe kit price)). · **DEFAULT:** **$29 one-time** · **UNBLOCKS:** the next click in this sequence
- [ ] **WHAT:** the publish click + preview/test purchase + public URL copied. · **UNBLOCKS:** the next click in this sequence
...
### Idempotency Key Test Kit — `docs/publishing/vetting/idempotency-key-test-kit.md` @ §7 checklist
...
### JWT Auth Test Kit — `docs/publishing/vetting/jwt-auth-test-kit.md` @ §7 checklist
...
### Pagination Test Kit — `docs/publishing/vetting/pagination-test-kit.md` @ §7 checklist
...
### Rate-Limit Test Kit — `docs/publishing/vetting/rate-limit-test-kit.md` @ §7 checklist
...
### The Auto-Merge Enabler Cookbook — `docs/publishing/vetting/auto-merge-enabler-cookbook.md` @ §7 checklist
...
### The Idempotency & Retry Cookbook — `docs/publishing/vetting/idempotency-retry-cookbook.md` @ §7 checklist
...
- [ ] **WHAT:** execute the Idempotency Key Test Kit ($29) publish click — blocking: the Idempotency kit publish click must be executed first (a Gumroad bundle references existing live products; queued OWNER-QUEUE D7, packet idempotency-key-test-kit.md §7). Nothing below proceeds. · **UNBLOCKS:** the next click in this sequence
- [ ] **WHAT:** execute the JWT Auth Test Kit ($29) publish click — blocking: the JWT Auth kit publish click must be executed first (same live-referent rule; queued OWNER-QUEUE D9, packet jwt-auth-test-kit.md §7). Nothing below proceeds. · **UNBLOCKS:** the next click in this sequence
- [ ] **WHAT:** execute the Pagination Test Kit ($29) publish click — blocking: the Pagination kit publish click must be executed first (same live-referent rule; queued OWNER-QUEUE D15, packet pagination-test-kit.md §7). Nothing below proceeds. · **UNBLOCKS:** the next click in this sequence
- [ ] **WHAT:** execute the Rate-Limit Test Kit ($29) publish click — blocking: the Rate-Limit kit publish click must be executed first (same live-referent rule; queued OWNER-QUEUE D18, packet rate-limit-test-kit.md §7). Nothing below proceeds. · **UNBLOCKS:** the next click in this sequence
...
- [ ] **WHAT:** execute the GitHub Webhook Test Kit ($29) publish click — blocking: the GitHub kit publish click must be executed first (a Gumroad bundle references existing live products; queued OWNER-QUEUE D6, packet github-webhook-test-kit.md §7). Nothing below proceeds. · **UNBLOCKS:** the next click in this sequence
- [ ] **WHAT:** execute the Slack Webhook Test Kit ($29) publish click — blocking: the Slack kit publish click must be executed first (same live-referent rule; queued OWNER-QUEUE D20, packet slack-webhook-test-kit.md §7). Nothing below proceeds. · **UNBLOCKS:** the next click in this sequence
- [ ] **WHAT:** execute the Shopify Webhook Test Kit ($29) publish click — blocking: the Shopify kit publish click must be executed first (same live-referent rule; queued OWNER-QUEUE D19, packet shopify-webhook-test-kit.md §7). Nothing below proceeds. (Stripe is already live since 2026-07-12 — so it carries no blocking row here.) · **UNBLOCKS:** the next click in this sequence
- [ ] **WHAT:** create the Gumroad bundle of the four live kits (New product → Bundle, all four components selected, or the single reproducible zip). · **UNBLOCKS:** the next click in this sequence
- [ ] **WHAT:** listing copy pasted from the bundle listing-copy. · **UNBLOCKS:** the next click in this sequence
- [ ] **WHAT:** price set ($79 one-time fixed — §3; $116-separate comparison cited in the copy, never the sale price). · **UNBLOCKS:** the next click in this sequence
- [ ] **WHAT:** the publish click + preview/test purchase delivering all four zips (sha256 spot-check against the §1 pins) + public bundle URL copied. · **UNBLOCKS:** the next click in this sequence
