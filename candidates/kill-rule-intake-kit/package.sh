#!/bin/sh
# package.sh — assemble a clean, buyer-facing bundle of the Kill-Rule
# Intake Kit into candidates/kill-rule-intake-kit/dist/kill-rule-intake-kit-v0.1.zip
#
...
SRC="$SCRIPT_DIR"
BUNDLE_NAME="kill-rule-intake-kit-v0.1"
DIST_DIR="$SRC/dist"
