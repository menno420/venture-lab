# The Salvage Orchard — large-print paperback edition spec

Production spec for a large-print paperback of the **full** novella (canonical
manuscript `../../en/the-salvage-orchard.md`, **15,045 words** per
`wc -w candidates/adult-novels/the-salvage-orchard/en/the-salvage-orchard.md` →
`15045`, 2026-07-13). **Spec only — no new manuscript needed**; the interior
...
([`docs/publishing/vetting/the-salvage-orchard.md`](../../../../../docs/publishing/vetting/the-salvage-orchard.md) §7).
...
- **Face:** high-legibility book face with open counters and distinct
  ...
  manuscript uses inline emphasis italics and a few short set-off italic
  lines (posted notices, the petition wording) — keep each insert short;
...
- Body: 15,045 words ÷ 160–200 wpp ≈ **75–94 pages**.
...
- **Recommended list: $12.99.** The adult large-print precedents
  ...
  **bottom of the only verified paperback band** ($12.99–$14.99, CHECKLIST
  §4). Yields ~$5.41–$5.49/unit. (Comparable large-print pricing not
...
- Content note from the manuscript front matter carries over verbatim (adult
  solarpunk fiction, near-future: remembered hardship from the years the grid
  came apart, a bereavement a season old, and civic conflict conducted
  entirely without violence; no gore, no explicit content).

## Title-specific notes

- Solarpunk skews to a younger, digital-first readership — probably the
  catalog's **weakest** demographic fit for large print, and the honest
  counterweight to writing the spec anyway: the marginal cost is near zero
  once this spec exists, and the format's accessibility case (low-vision
  readers of any age) is genre-independent. Demand **not measured**: no comps
  surveyed, no sales data exists for this title in any format.
- The subtitle *"A Solarpunk Novella"* stays on the cover (vetting packet §1
  recommends it ON).
...
1. Typeset interior from `../../en/the-salvage-orchard.md` at the spec above;
