...
per version. The EN master (`../en/the-salvage-orchard.md`, **15,045 words**
...
- A version must not contradict the title's vetted positioning
  (`../DECISIONS.md`, `docs/publishing/vetting/the-salvage-orchard.md`).
