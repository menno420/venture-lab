# The Glass Rectory — large-print paperback edition spec

Production spec for a large-print paperback of the **full** novella (canonical
manuscript `../../en/the-glass-rectory.md`, **15,117 words** per
`wc -w candidates/adult-novels/the-glass-rectory/en/the-glass-rectory.md` →
`15117`, 2026-07-13). **Spec only — no new manuscript needed**; the interior
...
([`docs/publishing/vetting/the-glass-rectory.md`](../../../../../docs/publishing/vetting/the-glass-rectory.md) §7).
...
- **Face:** high-legibility book face with open counters and distinct
  ...
  manuscript uses inline emphasis italics and a handful of short set-off
  italic lines (the tapping motif, garden-book fragments) — keep them, but
...
- Body: 15,117 words ÷ 160–200 wpp ≈ **76–94 pages**.
...
- **Recommended list: $12.99.** The adult large-print precedents
  (the-slow-word, ultramarine) recommended $14.99 for ~28–29k-word novels
  typesetting to ~170–190 pages; this is a **15k novella at ~100 pages** —
  half the extent — so it takes the **bottom of the only verified paperback
  band** ($12.99–$14.99, CHECKLIST §4) instead. Yields ~$5.41–$5.49/unit.
  (Comparable large-print pricing not surveyed — not measured.)
- KDP's minimum-list floor (print cost ÷ 0.60 ≈ $3.97) is no constraint. The
  practical floor is the market one: pricing below the verified band's $12.99
  start would undercut the (future) standard paperback for no reason.
...
- Content note from the manuscript front matter carries over verbatim (adult
  gothic fiction: bereavement, a long-past death from illness, and a
  disappearance — all off the page and in the past; no violence, no gore, no
  explicit content).

## Title-specific notes

- The classic ghost-story register (M.R. James / Susan Hill shelf) skews to a
  traditional print readership that overlaps the older large-print
  demographic more than most of the catalog — plausible fit, but demand is
  **not measured**: no comps surveyed, no sales data exists for this title in
  any format.
...
1. Typeset interior from `../../en/the-glass-rectory.md` at the spec above;
