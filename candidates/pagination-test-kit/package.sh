#!/bin/sh
# Build the buyer bundle for Pagination Test Kit v0.1.
# Bundles: the harness (pgtk.py + pgtk.js), the CORRECT + NAIVE reference pagers,
...
SRC="$SCRIPT_DIR"
BUNDLE_NAME="pagination-test-kit-v0.1"
DIST_DIR="$SRC/dist"
...
cp "$SRC/pgtk.py"                  "$ROOT/pgtk.py"
cp "$SRC/pgtk.js"                  "$ROOT/pgtk.js"
